export const diseaseData = [
    ...
    {label: 'Yellow Skin' , value: 'yellowish_skin'},
    ...
    {label: 'Accute Liver Failure' , value: 'acute_liver_failure'},
    ...
    {label: 'Redness od Eyes' , value: 'redness_of_eyes'},
    ...
    {label: 'Enlarged Thyrooid', value: 'enlarged_thyroid'} , 
    {label: 'Skin Rash', value: 'skin_rash'} , 
    {label: 'Brittle nails', value: 'brittle_nails'} , 
    {label: 'Swollen Ectremetics' , value: 'swollen_extremeties'} , 
    ...
    {label: 'Rusty Sutum', value: 'rusty_sputum' }, 
    ...
    {label: 'Yellow Cust Ooze', value: 'yellow_crust_ooze' }
